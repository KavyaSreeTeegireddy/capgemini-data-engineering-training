...
## Key Learnings
Importance of cleaning and preparing data before analysis. Understanding how joins help in combining datasets for better insights. Applying aggregation functions to compute meaningful metrics. Using conditional logic (when()) for business rules like segmentation. Building a complete end-to-end PySpark data processing pipeline
