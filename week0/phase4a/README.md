...
## Problem Statement 
To calculate total customer spend and then apply segmentation techniques like Gold, Silver, and Bronze.Compare rule-based, quantile-based, and ranking methods to identify the most effective segmentation approach.
